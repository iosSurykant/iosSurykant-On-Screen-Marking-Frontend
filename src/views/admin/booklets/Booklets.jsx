...
const Booklets = () => {
  ...
  const handleFileUpload = async (event) => {
    ...
    const BATCH_SIZE = 3; // 🔥 adjust (3–5 best)
    ...
    try {
      ...
      =============================== */
        ...
        //   .filter((file) => file.type === "application/pdf") // only PDF
        //   .map((file) => {
        //     const form = new FormData();
        //     form.append("file", file);

        //     return axios.post(
        //       `${process.env.REACT_APP_BACKEND_URL}/api/OmrProcessing/ExtractFils?SubjectId=${subjectCode}`,
        //       form
        //     );
        //   });
